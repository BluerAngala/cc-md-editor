...
function renderAboutAuthor(props: Record<string, string>): string {
  ...
  ${avatar ? `<section style="text-align: center; padding: 24px 20px 16px; background: #f9f6f0;"><img src="${esc(avatar)}" alt="${esc(name)}" style="display: block; margin: 0 auto; width: ${avatarW}px; height: ${avatarW}px; object-fit: cover; object-position: center top; border-radius: ${avatarR}; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" /></section>` : ``}
  ...
  ${avatar ? `<section style="text-align: center; padding: 28px 20px 16px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"><img src="${esc(avatar)}" alt="${esc(name)}" style="display: block; margin: 0 auto; width: ${avatarW}px; height: ${avatarW}px; object-fit: cover; object-position: center top; border-radius: ${avatarR}; box-shadow: 0 4px 16px rgba(0,0,0,0.3);" /></section>` : ``}
